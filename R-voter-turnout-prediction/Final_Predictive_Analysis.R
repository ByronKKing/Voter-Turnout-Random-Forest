...
##code nan or unknown as missing
is.na(temp) <- temp=="nan"
...
# Run final turnout predictions
voterturnout_2014<-finalprediction[finalprediction$vote==1,]
summary(voter_turnout2014)



# Write predictions as dataframe
write.csv(finalprediction, '/Users/bkking/Desktop/Optimus Project/optimus_modeling_exercise.csv')
