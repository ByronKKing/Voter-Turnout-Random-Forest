...
setwd('/Users/bkking/Desktop/0ptimus Project')
...
##create temp dataframe with variables with missing values above 20,000
...
##create temp dataframe with variables with missing values below 20,000
...
##examine correlation with other variables
...
# Descriptive stats and eneral exploratory data analysis
...
###create pie chart with all parties
...
###create barchart with abridged party distinctions
...
# Analyze general/primary turnout rates
